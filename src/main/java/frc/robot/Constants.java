...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        // if center of robot is (0,0) then Positive X moves to front and Positive Y
        // moves toward left
    ...
    public static final class WristConstants {
        ...
        public final static InvertedValue wrist2Direction = InvertedValue.CounterClockwise_Positive; // or
                                                                                                     // Clockwise_Positive
        /*
         ************************************************************************************************
         * THESE VALUES NEED TO CHANGE IF WE WORK ON THE Intake Subsystem !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    public static final class ArmConstants {
        ...
        public final static int proximalEstimatedAutoAbsolute = proximalAbsoluteTicsCenter - 205; // 2565; // only used
                                                                                                  // if we are not
                                                                                                  // getting reasonable
                                                                                                  // values from
                                                                                                  // absolute encoder
        public final static int distalEstimatedAutoAbsolute = distalAbsoluteTicsCenter + 206; // 1926; // only used if
                                                                                              // we are not getting
        ...
        public final static int[] proximalAbsoluteBounds = new int[] { proximalAbsoluteTicsCenter - 714,
                proximalAbsoluteTicsCenter + 1286 }; // 2000 4000
        public final static int[] distalAbsoluteBounds = new int[] { distalAbsoluteTicsCenter - 790,
                distalAbsoluteTicsCenter + 710 }; // 1000, 2500
        ...
        public final static int[] proximalAbsoluteBoundsAuto = new int[] { proximalEstimatedAutoAbsolute - 150,
                proximalEstimatedAutoAbsolute + 150 }; // {2430, 2585}
        public final static int[] distalAbsoluteBoundsAuto = new int[] { distalEstimatedAutoAbsolute - 100,
                distalEstimatedAutoAbsolute + 100 }; // {1925, 2060}
         ...
         */
        public final static Gains kGains_MotProf = new Gains(0.25, 0.0, 0.0, 1023.0 / 15200.0, 400, 1.00); /*
                                                                                                            * measured
                                                                                                            * 6800
                                                                                                            * velocity
                                                                                                            * units at
