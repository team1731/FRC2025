...
public class CoralScoreL1Transitions {
    private static final Object transitionTable[][] = {
        ...
        // Abort sequences
        {SequenceState.RAISING_ELEVATOR,        SequenceInput.BUTTON_RELEASED,            "startIntakeReset",          SequenceState.FINISHING},
        {SequenceState.MOVING_ARM_FORWARD,      SequenceInput.BUTTON_RELEASED,            "startIntakeReset",          SequenceState.FINISHING}
    };
