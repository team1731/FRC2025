...
public class RunSequenceCommand extends Command {
    ...
    public RunSequenceCommand(OLD_ElevatorSubsystem elevatorSubsystem, OLD_ArmSubsystem armSubsystem, OLD_HandClamperSubsystem clamperSubsystem, OLD_HandIntakeSubsystem intakeSubsystem) {
