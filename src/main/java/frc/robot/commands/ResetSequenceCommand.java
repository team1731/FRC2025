...
public class ResetSequenceCommand extends Command {
    ...
    public ResetSequenceCommand(ElevatorSubsystem elevatorSubsystem, OLD_ArmSubsystem armSubsystem, HandClamperSubsystem clamperSubsystem, HandIntakeSubsystem intakeSubsystem) {
