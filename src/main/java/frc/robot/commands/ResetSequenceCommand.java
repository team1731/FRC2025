...
public class ResetSequenceCommand extends Command {
    ...
    public ResetSequenceCommand(OLD_ElevatorSubsystem elevatorSubsystem, OLD_ArmSubsystem armSubsystem, OLD_HandClamperSubsystem clamperSubsystem, OLD_HandIntakeSubsystem intakeSubsystem) {
