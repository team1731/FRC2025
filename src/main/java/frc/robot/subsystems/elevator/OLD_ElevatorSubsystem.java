...
public class OLD_ElevatorSubsystem extends SubsystemBase implements IToggleableSubsystem {
    ...
    public OLD_ElevatorSubsystem(boolean enabled) {
    ...
    private void initializeElevatorMotors() {
        ...
        elevatorMotor1 = new TalonFX(ElevatorConstants.masterCanId1, "canivore1");
        elevatorFollower = new TalonFX(ElevatorConstants.followerCanId2, "canivore1");
