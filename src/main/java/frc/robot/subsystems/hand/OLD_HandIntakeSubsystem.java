...
public class OLD_HandIntakeSubsystem extends SubsystemBase implements IToggleableSubsystem {
    ...
    public OLD_HandIntakeSubsystem(boolean enabled) {
    ...
    private void initializeMotor() {
        ...
        motor = new TalonFX(HandConstants.intakeCanId, "canivore2");
